...
<body class="bg">
	<div id="helpDialoge" title="CrowdFlow Help">
		<p>CrowdSource is a Research project developed under the supervision of Center for Ubiquitous Computing, University Of Oulu.</p>
